...
## function plot_error{S <: FunctionSet{2}}(s::SetExpansion{S}, g::Function, D::AbstractDomain2d; n=300)
##     Tgrid = grid(similar(s,eltype(f),(n,n)))
##     Z = evalgrid(Tgrid, d)
...
##     plot_grid(Mgrid)
## end
## function plot_expansion(S<)
## function plot_expansion(S <: SetExpansion{1}; n=201, repeats=0, color="blue", alpha=1.0)
##     G = grid(resize(basis(S),n))
